...
YUI({
    ...
    YAHOO.proplus.conpa.init = function () {
            ...
            pieChart = new Y.Chart({
                ...
                tooltip: {
                    markerLabelFunction: function (cItem, vItem, iItem, s, sI) {
                        return cItem.value + " " +
                            Y.DataType.Number.format(vItem.value, {
                                suffix: "%",
                                decimalPlaces: 2
                            });
                    }
        ...
        function createPerformanceChart() {
            ...
            performanceChartPanel.subscribe("hide", function () {
                perfChart.destroy();
            });
            ...
            perfChart = new Y.Chart({
                ...
                tooltip: {
                    markerLabelFunction: function (cItem, vItem, iItem, s, sI) {
                        return labelReferenceDateButton(new Date(cItem.value)) +
                            " " +
                            Y.DataType.Number.format(vItem.value, {
                                suffix: "%",
                                decimalPlaces: 2
            ...
            myDataTable.subscribe("cellClickEvent", function (ev) {
                ...
                function exitGetKeyStatistics() {
                    ...
                    function exitGetImpliedVolatility() {
                        ...
                        // callLineChart.set('dataProvider', vol.callVolatility);
                        // callLineChart.render('#callVolChart');
                        ...
                        units: [
                            ...
                            },
                            {
                                ...
                                body: "<div id=\"impliedVolHeader\"></div>" +
                                    ...
                                    "<div id=\"callVolChart\" style=\"height:200px; width:511px;\"><\/div>" +
        ...
        function initGetOptimalPortfolio() {
            ...
            function onGetOptimalPortfolioClick() {
                ...
                optHandle = Y.on('io:failure', function () {
